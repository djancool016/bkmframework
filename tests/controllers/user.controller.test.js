...
const testCases = {
    ...
    register: [
        {
            input: {body: {roleId: 2, username: 'new_user', password: 'new_password', email: 'new_user@example.com', name: 'New User', phone: '1234567890', address: 'Jakarta, Indonesia', nik: '1234567890123'}},
            output: {httpCode: 201},
            description: 'Valid user registration should return Http 201'
        },{
            input: {body: {roleId: 1, username: 'admin', password: 'new_password', email: 'existing_user@example.com', name: 'Existing User', phone: '0987654321', address: 'Bandung, Indonesia', nik: '3210987654321'}},
